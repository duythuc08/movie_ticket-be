...
public class AuthenticationController {
	...
	ApiResponse<IntrospectResponse> authenticate(@RequestBody IntrospectResquest resquest)
	...
	public ApiResponse<UsersRespone> register(@RequestBody RegisterRequest request) {
		...
		return ApiResponse.<UsersRespone>builder().result(result)
				.message("Đăng ký thành công, vui lòng kiểm tra email để xác thực").build();
	}
	...
	public ApiResponse<Void> forgotPassword(@Valid @RequestBody ForgotPasswordRequest request) {
		...
		return ApiResponse.<Void>builder().message("OTP đã được gửi tới email").build();
	}
	...
	public ApiResponse<Void> resetPassword(@Valid @RequestBody ResetPasswordRequest request,
		...
		return ApiResponse.<Void>builder().message("Lấy mật khẩu thành công").build();
	}
